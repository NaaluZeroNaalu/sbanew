...
<footer className="bg-black text-white py-6">
  <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center md:items-start">
    ...
    <div className="flex gap-6 mb-4 md:mb-0">
      <a href="#services" className="text-white hover:text-white transition duration-300" style={{textDecoration:"none"}}>Services</a>
      <a href="#about" className="text-white hover:text-white transition duration-300" style={{textDecoration:"none"}}>About Us</a>
      <a href="#contact" className="text-white hover:text-white transition duration-300" style={{textDecoration:"none"}}>Contact</a>
      <a href="#privacy" className="text-white hover:text-white transition duration-300" style={{textDecoration:"none"}}>Privacy Policy</a>
    </div>
